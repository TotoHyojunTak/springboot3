...
class NaverClientControllerTest {
    ...
    @Test
    void getNaverBlogListByFeignclientTest() throws Exception {
        // given
        String keyword = "여행";
        String sort = "accuracy";
        Integer page = 1;
        ...
        // when
        ResultActions resultActions = mockMvc.perform(RestDocumentationRequestBuilders.get("/blog/naver/search/feign")
                        .param("query", keyword)
                        .param("sort", sort)
                        .param("page", String.valueOf(page))
                        .param("size", String.valueOf(size))
